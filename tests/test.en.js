...
const timeago = require('../dist/timeago.en');
const fs = require('fs');
const pys = require('pys');
const testBuilder = require('./test-builder');

test('timeago.en.js should be tested', t => {
  // locale tests #################################################################
  ...
  t.notEqual(timeago('2016-06-23').format('2016-06-22', 'zh_CN'), '1天前');
  t.notEqual(timeago('2016-06-23').format('2016-06-25', 'zh_CN'), '2天后');
  ...
  // test default locale
  t.equal(timeago('2016-03-01 12:00:00').format('2016-02-28 12:00:00'), '2 days ago');
  t.notEqual(timeago('2016-03-01 12:00:00', 'zh_CN').format('2016-02-28 12:00:00'), '2天前');
  ...
  t.notEqual(newTimeAgo.format('2016-02-28 12:00:00'), '2天前');
  ...
  t.notEqual(newTimeAgoDefaultLocale.format('2016-02-28 12:00:00', 'zh_CN'), '2天前');
  t.end();
});
